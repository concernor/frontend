...
//           might be frontends that restrict access to certain countries. it
//           doesn&apos;t prevent you from buying $CONCERN through other frontends
...
//       <div className="text-muted-foreground text-sm space-y-2">
//         <p>
//           To begin your $CONCERN journey, you&apos;ll need a cryptocurrency
//           wallet supporting the Base network. <strong>MetaMask</strong> is the
//           most widely used option, though alternatives like{" "}
//           <strong>Rabby Wallet</strong> or <strong>Coinbase Wallet</strong> are
//           equally effective.
//         </p>
//         <ol className="list-decimal pl-4">
//           <li>
//             <strong>
//               Download Rabby, Coinbase Wallet, MetaMask or any other wallet
//               supporting the Base network
//             </strong>
//             : Install the browser extension or mobile app from official sources.
//           </li>
//           <li>
//             <strong>Create/Import Wallet</strong>: Generate a new wallet or
//             import an existing one using a recovery phrase.
//           </li>
//           <li>
//             <strong>Secure Your Wallet</strong>: Enable two-factor
//             authentication (2FA) and store your recovery phrase offline
//             (recommended if your wallet supports it).
//           </li>
//         </ol>
//       </div>
//     ),
...
//         <ol className="list-decimal pl-4">
//           <li>
//             Open your wallet and navigate to <strong>Networks</strong> &gt;{" "}
...
//               </li>
//               <li>
//                 <strong>RPC URL</strong>: <code>https://mainnet.base.org</code>
//               </li>
//               <li>
...
//         <ol className="list-decimal pl-4">
//           <li>
//             <strong>Sign Up</strong>: Create an account on platforms like{" "}
//             <strong>Binance</strong>, <strong>Coinbase</strong>, or{" "}
//             <strong>Kraken</strong>.
//           </li>
//           <li>
//             <strong>Buy ETH</strong>: Use fiat currency (USD, EUR, etc.) to
//             purchase ETH via bank transfer or credit card.
//           </li>
//         </ol>
//       </div>
//     ),
...
//         <ol className="list-decimal pl-4">
//           <li>
//             Visit <strong>Stargate Finance</strong> or{" "}
//             <strong>Base Bridge</strong>.
//           </li>
//           <li>Connect your wallet and select the amount to transfer.</li>
//           <li>
//             Confirm the bridge transaction (allow ~5-10 minutes for completion).
//           </li>
//         </ol>
//       </div>
//     ),
...
//           </li>
//           <li>
//             Click <strong>Connect Wallet</strong> and authorize your wallet.
//           </li>
//           <li>Select the amount of ETH you want to spend on $CONCERN.</li>
//           <li>
//             Click <strong>Buy $CONCERN</strong>.
//           </li>
//         </ol>
//       </div>
//     ),
...
//         <ol className="list-decimal pl-4">
//           <li>
//             Navigate to <strong>uniswap.org</strong> on the Base network.
//           </li>
//           <li>
//             Click <strong>Connect Wallet</strong> and authorize your wallet.
//           </li>
...
//         <ol className="list-decimal pl-4">
//           <li>
//             In the swap interface, paste $CONCERN&apos;s contract address:
//             <br />
//             <code>0x8f5a590be0b27feb5bffaab82bbf31d3c7efe222</code>
//             <br />
//             <em>
//               Always verify this address via $CONCERN&apos;s official channels
//               to avoid scams.
//             </em>
//           </li>
//         </ol>
...
//         <ol className="list-decimal pl-4">
//           <li>
//             In your wallet, click <strong>Import Tokens</strong>.
//           </li>
//           <li>
//             Paste $CONCERN&apos;s contract address to auto-populate details.
//           </li>
...
//         <ul className="list-disc pl-4">
//           <li>
//             Transfer majority holdings to a <strong>hardware wallet</strong>{" "}
//             (Ledger/Trezor).
//           </li>
